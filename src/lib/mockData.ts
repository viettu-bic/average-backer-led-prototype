...
export const MOCK_REQUESTS: CoachingRequest[] = [
  {
    ...
    description:
      "Looking for an experienced vlogger to coach me on storytelling, camera work, editing, and building an audience. I'm a complete beginner with a passion for travel content. Ideally someone who's grown a channel to 10k+ subscribers organically. Flexible on scheduling—weekdays preferred.",
    backerName: "Alex Rivers",
    backerHandle: "@alexrivers",
    backerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=alexrivers",
    backerBio:
      "Travel enthusiast and aspiring content creator. Been to 30+ countries and want to share those stories with the world. Corporate job by day, camera in hand on weekends.",
  ...
  },
  {
    ...
    description:
      "I've been hardstuck Diamond 2 for 3 seasons. Need coaching on agent selection, macro play, map control, and mental resilience under pressure. Available weekends only. Prefer someone who's hit Radiant or is an ex-professional player. VOD review sessions welcome.",
    backerName: "Sarah Kim",
    backerHandle: "@sarahk_gg",
    backerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=sarahkim",
    backerBio:
      "Competitive gamer, Diamond 2 Valorant. Playing since beta. Looking to finally break through to Immortal before the next act ends.",
    remainingTime: "1d 6h",
    coachingDuration: 90,
    price: 60,
  ...
  },
  {
    ...
    backerBio:
      "Software engineer by day, music lover by heart. Always wanted to play guitar and now finally committing to learning it properly.",
    remainingTime: "3d 2h",
    coachingDuration: 30,
    price: 45,
  ...
  },
  {
    ...
    backerBio:
      "Self-taught dev with 1 year of experience, currently building a SaaS product. Passionate about clean code and learning from experienced engineers.",
    remainingTime: "5d 0h",
    coachingDuration: 60,
    price: 120,
    ...
    applicants: [
      ...
      },
      {
        ...
        message:
          "Full-stack dev and open-source maintainer (12k GitHub stars on my React toolkit). I love teaching clean architecture, TDD, and React best practices. I've worked with self-taught devs many times—your background is an asset, not a drawback!",
  ...
  },
  {
    ...
    description:
      "B1/B2 level Spanish learner seeking a native speaker for weekly conversation sessions. Focus on fluency, idioms, and Latin American culture. Flexible schedule, any timezone works. I'm preparing for a relocation to Mexico City and need to get my conversational Spanish work-ready.",
    backerName: "Tom Bradley",
    backerHandle: "@tombradley",
    backerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=tombradley",
    backerBio:
      "Marketing professional planning to relocate to Mexico City next year. Need to sharpen Spanish conversational fluency for work meetings and daily life.",
    remainingTime: "4d 8h",
    coachingDuration: 30,
    price: 35,
  ...
  },
  {
    ...
    description:
      "Running my first marathon in 6 months. Need a coach to build a periodized training plan, advise on nutrition timing, and help me hit a sub-4:30 goal. Currently running 25km/week. I have access to a track and a gym. Looking for weekly check-ins and a structured plan.",
    backerName: "Mia Johnson",
    backerHandle: "@miajruns",
    backerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=miajohnson",
    backerBio:
      "Amateur runner with 5k and 10k races under my belt. Ready to take the big leap to marathon distance and need expert guidance to do it safely.",
